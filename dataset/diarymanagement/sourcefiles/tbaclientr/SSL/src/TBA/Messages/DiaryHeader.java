...
public class DiaryHeader
{
    ...
    *<p>
    *<p>
    * @returns The actual Diary Header record 
    *<p>
    ...
    *<p>
    * @returns Any data left after the record
    *<p>
    * @throws MessagesException
    *<p>
    * @see #Get()
   ...
   public String Set(String record) throws MessagesException
   {
      ...
      diaryName = record.substring(0, diaryNameLen);
    ...
    *<p>
    * @param Code The 'Diary ID' to set
    *<p>
    * @throws MessagesException
    *<p>
    * @see #GetDiaryID()
    ...
    *<p>
    * @param Message The Diary name to set
    *<p>
    * @throws MessagesException
    *<p>
    * @see #GetDiaryName()
    ...
    *<p>
    * @param Message The Owner flag to set. Either 'Y' or 'N'
    *<p>
    * @throws MessagesException
    *<p>
    * @see #GetOwnerFlag() 
