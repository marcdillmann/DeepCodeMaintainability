...
public class LoginResponse extends ResponseMessage
{
   ...
   Vector<DiaryHeader> diaryHeaderRecords = new Vector<DiaryHeader>();
   ...
   public String Set(String message) throws MessagesException
   {
      ...
      DiaryHeader tempRecord = new DiaryHeader();
    ...
    *<p>
    * @returns The Default Diary's ID
    *<p>
    ...
    *<p>
    * @returns A Vector containing all the Diary Header records.
    *<p>
    * @see #SetErrorMessage(java.lang.String)
    */
   public Vector<DiaryHeader> GetDiaryHeaders()
   {
      return (Vector<DiaryHeader>)diaryHeaderRecords.clone();
   }
    ...
    * @see #GetDiaryHeaders() 
    */
   public void SetDiaryHeaders(Vector<DiaryHeader> records) throws MessagesException
   {
      if(records == null)
      {
         diaryHeaderRecords = new Vector<DiaryHeader>();
         throw new MessagesException("The Diary header records are null");
      }
      else
      {
         diaryHeaderRecords = (Vector<DiaryHeader>)records.clone();
