...
/**
 * This class is for the GetUpdResponse message, it is a response to a GetUpdQuery
 *<p>
 * @author Dan McGrath
 *
...
public class GetUpdResponse extends ResponseMessage
{
   ...
   //private final int GetUpdResponseLen = DiaryNameLen + ownerFlagLen + permissions + revisionNo + totalEntrySize();
    ...
    /**
    * This method returns total GetUpdResponseLen string length including the
     * total entry size of all entries
    ...
    * GetUpdResponse fields cant be null
    ...
    */
    ...
    public String Get(String dummy) throws MessagesException
    {
     ...
     /**
     * Sets the fields of a GetUpdResponse class from string made from Get()
