...
public class Messages
{
   ...
   /** This field represents the length of the message header **/
    ...
    *<p>
    * @return The message without the 'Message Header'
    *<p>
    * @throws MessagesException
    *<p>
    ...
    *<p> 
    * @return The Message Type. Possible values are:
    * 'Q' for Query,
    * 'R' for Response, or
    ...
    *<p> 
    * @return The Session ID or null if one is not set.
    *<p>
